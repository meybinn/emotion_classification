...
# # print(classification_report(test["label"], pred_test, labels=[0,1,2], target_names=["NORMAL","SAD","ANGRY"]))
# print(test["label"].value_counts())
# print("pd.Series(pred_test).value_counts()",pd.Series(pred_test).value_counts())
